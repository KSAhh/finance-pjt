...
class Product(models.Model):
    ...
    fin_prdt_cd = models.CharField(max_length=255, unique=True, default="Unknown")  # 금융 상품 코드
    fin_prdt_nm = models.CharField(max_length=255, default="Unknown")               # 금융 상품명
    join_way = models.CharField(max_length=255, default='-')                                       # 가입 방법 (JSON 배열)
    mtrt_int = models.TextField(default="-")                                        # 만기 후 이자율 조건 설명
    spcl_cnd = models.TextField(default="-")                                        # 우대 조건
