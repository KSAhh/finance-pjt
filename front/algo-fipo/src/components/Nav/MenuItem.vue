  ...
  <li class="px-4 lg:px-6 xl:px-8 relative group">
    ...
    >
      <div class="flex h-full">
        <!-- 첫 번째 영역 -->
        <div class="w-1/3 bg-gray-100 p-6 shadow-sm animate-slide-in-left">
        ...
        <!-- 세 번째 영역 -->
        <div class="w-1/3 bg-gray-100 p-6 rounded-lg shadow-sm animate-slide-in-right">
          <h3 class="text-lg font-semibold border-b pb-2 mb-4 border-gray-300">추가 정보</h3>
          <p class="mt-2 text-sm text-gray-600 leading-relaxed">
